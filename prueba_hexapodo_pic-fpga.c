#include <prueba_hexapodo_pic-fpga.h>
//// configuraciones ////
...
void elegir_estado_actual()
{
   ...
   else if (estado_actual == 2 && ok == 1 && input(boton_esconderse) == 0 && input(boton_pararse) == 0 && input(boton_caminar_atras) == 0)  // Si ha recivido el "ok" corectamente pasa a mandar pata1
      {                       
        estado_actual = 3;  
         ok=0;//limpiamos el flag
      }  
   ...
   else if (estado_actual == 3 && ok == 1)  // Si ha recivido el "ok" corectamente pasa a mandar pata1
      {                       
        estado_actual = 4;  
         ok=0;//limpiamos el flag
      }  
   ...
   else if (estado_actual == 4 && ok == 1)  // Si ha recivido el "ok" corectamente pasa a mandar pata1
      {                       
        estado_actual = 5;  
         ok=0;//limpiamos el flag
      }  
   ...
   else if (estado_actual == 5 && ok == 1)  // Si ha recivido el "ok" corectamente pasa a mandar pata1
      {                       
        estado_actual = 6;  
         ok=0;//limpiamos el flag
      }  
   ...
   else if (estado_actual == 6 && ok == 1)  // Si ha recivido el "ok" corectamente pasa a mandar pata1
      {                       
        estado_actual = 7;  
         ok=0;//limpiamos el flag
      }  
   ...
   else if (estado_actual == 7 && ok == 1)  // Si ha recivido el "ok" corectamente pasa a mandar pata1
      {                       
        estado_actual = 8;  
         ok=0;//limpiamos el flag
      }  
   ...
   else if (estado_actual == 8 && ok == 1)  // Si ha recivido el "ok" corectamente pasa a mandar pata1
      {                       
        estado_actual = 9;  
         ok=0;//limpiamos el flag
      }  
   ...
   else if (estado_actual == 9 && ok == 1)  // Si ha recivido el "ok" corectamente pasa a mandar pata1
      {                       
        estado_actual = 11;  
         ok=0;//limpiamos el flag
      }  
   else if (estado_actual == 9 && error == 1)  // si se ha activado error haz lo que hace estado error
      {                       
         estado_actual = 10;  // ESTADO DE ERROR.  
      }
   ...
   else if (estado_actual == 47 && ok == 1 && input(boton_esconderse) == 0 && input(boton_pararse) == 0 && input(boton_caminar_adelante) == 0)  // Si ha recivido el "ok" corectamente pasa a mandar pata1
      {                       
        estado_actual = 50;  
         ok=0;//limpiamos el flag
      }  
                   ...
                   for (int k=0 ; k<8 ; k++)
                      {
                        ...
                        if(flanco_subida == 0 && n_bits == k)
                        {
                           bit_envio = 0b10101111>>k & 0b00000001 ;   //Enviamos los 175grados en binario MOTOR 2
                           output_bit(tx,bit_envio);
                           n_bits = k+1;
                           delay_us(600);
                        }
                   ...
                   for (int k=0 ; k<8 ; k++)
                      {
                        ...
                        if(flanco_subida == 0 && n_bits == k)
                        {
                           bit_envio = 0b10101010>>k & 0b00000001 ;   //Enviamos 170grados en binario MOTOR 3
                           output_bit(tx,bit_envio);
                           n_bits = k+1;
                           delay_us(500);
                        }
