...
*/                    
                   ...
                   /////////////////////////MOVIMIENTO 1////////////////////////////////////////////
int matrix[24][3] ={{0b01011111, 0b01101110, 0b01101110},  /// 3 BYTES DE GRADOS PARA PATA1  95grados,110grados,110grados.
                    ...
                    {0b01111101, 0b01101110, 0b01101110},  /// 3 BYTES DE GRADOS PARA PATA5  125grados,110grados,110grados.
                    {0b01000110, 0b01101110, 0b01101110},  /// 3 BYTES DE GRADOS PARA PATA6  70grados,110grados,110grados.
                   
                           ///////////MOVIMIENTO 2///////////////////
                    {0b01001011, 0b10010110, 0b10000010},  /// 3 BYTES DE GRADOS PARA PATA1  75grados,150grados,130grados.
                    ...
                    {0b01101001, 0b10010110, 0b10000010},  /// 3 BYTES DE GRADOS PARA PATA5  105grados,150grados,130grados.
                    {0b01011010, 0b01101110, 0b01101110},  /// 3 BYTES DE GRADOS PARA PATA6  90grados,110grados,110grados.
                    
                          ///////////MOVIMIENTO 3///////////////////
                    {0b00110010, 0b01101110, 0b01101110},  /// 3 BYTES DE GRADOS PARA PATA1  50grados,110grados,110grados.
                    ...
                    {0b01010101, 0b01101110, 0b01101110},  /// 3 BYTES DE GRADOS PARA PATA5  85grados,110grados,110grados.
                    {0b01101110, 0b01101110, 0b01101110},  /// 3 BYTES DE GRADOS PARA PATA6  110grados,110grados,110grados.
                    
                            ///////////MOVIMIENTO 4///////////////////
                    {0b01001011, 0b01101110, 0b01101110},  /// 3 BYTES DE GRADOS PARA PATA1  75grados,110grados,110grados.
                    ...
                    {0b01101001, 0b01101110, 0b01101110},  /// 3 BYTES DE GRADOS PARA PATA5  105grados,110grados,110grados.
                    {0b01011010, 0b10010110, 0b10000010}};  /// 3 BYTES DE GRADOS PARA PATA6  90grados,150grados,130grados.
...
int saludo[12][3] ={{0b01011010, 0b01011010, 0b01011010},  /// 3 BYTES DE GRADOS PARA PATA1  90grados,90grados,90grados.
                    {0b00101000, 0b10011011, 0b00000000},  /// 3 BYTES DE GRADOS PARA PATA2  40grados,155grados,0grados.
                    ...
                    {0b01101110, 0b10011011, 0b00000000},  /// 3 BYTES DE GRADOS PARA PATA2  110grados,155grados,0grados.
                    {0b01011010, 0b01011010, 0b01011010},  /// 3 BYTES DE GRADOS PARA PATA3  90grados,90grados,90grados.
                    {0b01011010, 0b01011010, 0b01011010},  /// 3 BYTES DE GRADOS PARA PATA4  90grados,90grados,90grados.
                    {0b01011010, 0b01011010, 0b01011010},  /// 3 BYTES DE GRADOS PARA PATA5  90grados,90grados,90grados.
                    {0b01011010, 0b01011010, 0b01011010}};  /// 3 BYTES DE GRADOS PARA PATA6  90grados,90grados,90grados.
...
#INT_TIMER0
void interrupt()   // cada 125us entra
{
      if(flanco_subida == 0)
      {
            output_bit(clk,1);
...
{              
   ...
   set_timer0(100);                  // desborda en 125us        // cada tic es de 800ns
